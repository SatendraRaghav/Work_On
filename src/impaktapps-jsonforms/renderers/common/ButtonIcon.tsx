...
export function ButtonIcon(iconName: string, data: any) {
  switch (iconName) {
    ...
    case "PendingIcon":
      return <PendingActionsOutlinedIcon sx={{ ...data?.iconStyle }} />;
    case "BackIcon2":
      return <BackIcon2 sx={{ ...data?.iconStyle }} />;
    case "ViewIcon":
      return <RemoveRedEyeOutlinedIcon sx={{ ...data?.iconStyle }} />;
    case "NotificationIcon":
      return <NotificationImportantOutlinedIcon sx={{ ...data?.iconStyle }} />;
    case "PersonIcon":
      return <PersonIcon sx={{ ...data?.iconStyle }} />;
    case "ReportIcon":
      return <SummarizeOutlinedIcon sx={{ ...data?.iconStyle }} />;
    case "ErrorIcon":
      return (
        <ErrorOutlineOutlinedIcon color="error" sx={{ ...data?.iconStyle }} />
      );
    case "RefreshIcon":
    ...
    case "ExceptionIcon":
      return (
        ...
        >
          ...
          >
            <path
              d="M1910 4709 c-879 -101 -1542 -868 -1507 -1744 18 -447 186 -833 497
         ...
         438 226 674 256 116 14 348 5 468 -20z"
            />
            <path
              d="M2013 3903 c-23 -8 -58 -31 -78 -51 -34 -35 -678 -1093 -716 -1177
         ...
         1142 -716 1177 -61 63 -162 83 -252 51z"
            />
            <path
              d="M2064 3441 c-12 -5 -31 -22 -43 -37 -21 -26 -21 -35 -21 -366 0 -274
         3 -344 14 -367 35 -66 137 -66 172 0 11 23 14 93 14 368 l0 341 -27 30 c-30
         32 -75 45 -109 31z"
            />
            <path
              d="M2047 2479 c-22 -13 -47 -61 -47 -93 0 -14 13 -40 29 -58 24 -27 36
