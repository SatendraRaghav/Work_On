...
const RunnerProgressBar = ({
  ...
  return (
    <ComponentWrapper
      additionalProps={ctx.core.data?.additionalProps?.[finalPath]}
    ...
    >
      ...
      >
        ...
        >
          <img
            src={
              "https://media1.giphy.com/media/JTOaN2A7IVwoGKIQ11/giphy.gif?cid=ecf05e47oxseox7hagztx1974svhjicmd09zlj0au9zewn8v&ep=v1_stickers_search&rid=giphy.gif&ct=s"
            }
            alt="Image Not Found"
            style={{
              fontFamily: "inherit",
        ...
        >
          {data.message || `${progress}% work done`}
        </Box>
        <Box
          sx={{
            position: "absolute",
        ...
        >
          <img
            src={
              "https://tse2.mm.bing.net/th?id=OIP.4mtQjTlFWqEt6ze9dSB2DwHaLi&pid=Api&P=0&h=180"
            }
            alt="Image Not Found"
            style={{
              textAlign: "center",
