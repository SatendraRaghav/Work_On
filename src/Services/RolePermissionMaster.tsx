            ...
            const Data = service
                ...
                .then((res) => {
                    ...
                    RolePermissionApprover: function () {
                        service.post("/master/approve?masterName=com.act21.hyperform3.entity.master.role.RolePermissionStaging", otherData[0]).then((res:any) => {
                            console.log("approved")
                            this.getFormData()
                        })
                    },
                    Reject_Records: function () {
                        service.post("/master/rejected?masterName=com.act21.hyperform3.entity.master.role.RolePermissionStaging", otherData[0]).then((res:any) => {
                            this.getFormData();
                        })
                    },
                    newRecord: () => {
                    ...
                    Edit_Approve_Records: () => {
                        const Api = "/master/getDetailById?masterName=com.act21.hyperform3.entity.master.role.RolePermissionStaging"
                        service.post(Api, { id: otherData[0].id }).then((res: any) => {
