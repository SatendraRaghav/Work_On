    ...
    return {
        ...
        onChange: async () => {
            ...
            const result: any = await service
                ...
                if (store?.formData?.programCycle !== store.newData?.programCycle && store?.newData?.programCycle !== undefined) {
                    ...
                    const myObj = {
                        payload: {
                            ...
                            programCycleId: store.newData.programCycle,
