export function IconProvider(iconName: string, activeValue?: boolean) {
  ...
  switch (originalIconName) {
    ...
    case "Cycle":
      return <svg viewBox="0 0 48 48"  width="20px"
      height="20px" xmlns="http://www.w3.org/2000/svg" fill="#000000" stroke="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><defs></defs><path  d="M41.079,20.7015a17.2046,17.2046,0,0,0-4.7825-9.0079,17.4609,17.4609,0,0,0-24.6244,0"></path><path  d="M6.89,27.32a17.423,17.423,0,0,0,29.4064,8.9756"></path><polygon  points="10.121 10.149 13.579 13.604 18.2 18.221 5.5 18.221 5.5 5.5 10.121 10.149"></polygon><polygon  points="34.421 34.428 29.768 29.779 42.5 29.779 42.5 42.5 37.879 37.883 34.421 34.428"></polygon></g></svg>;
